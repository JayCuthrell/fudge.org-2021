...
Basically, in this post I wanted to capture some thoughts over the past 90 days (technically 116). While I have more thoughts that are topical, I'll use this post to reflect on multicloud.
...
* You'll see varied LACP, EBGP-4, 802.1Q, varied MTUs, and more.
...
Oh, I still maintain that my predictions in [Social Telecom 2030](https://fudge.org/social-telecom-2030) will eventually become true: 
